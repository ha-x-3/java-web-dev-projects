...
public abstract class Media extends BaseDisc{
    ...
    public Media(String name, String diskType, int spinRate, double capacity) {
        super(name, diskType, spinRate);
    ...
    public boolean filePresent(File file) {
        if (getFiles().contains(file)) {
            ...
            System.out.println("That file does not exist on this " + getDiskType() + ".");
            return false;
        }
    }
